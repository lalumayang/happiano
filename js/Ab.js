...
function start(e) {
  ...
  var notes = [
    new VF.StaveNote({clef: "treble", keys: ["a/3"], duration: "q" }).addAccidental(0, new VF.Accidental("b")),
    new VF.StaveNote({clef: "treble", keys: ["b/3"], duration: "q" }).addAccidental(0, new VF.Accidental("b")),
